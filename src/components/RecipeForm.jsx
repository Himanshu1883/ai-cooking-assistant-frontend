...
const RecipeForm = () => {
    ...
    const startCommandRecognition = () => {
        ...
        recognition.onend = () => {
            if (commandRecognitionRef.current) recognition.start();
        };
        ...
        <>
            <div className="container mt-5">
                ...
                <form onSubmit={handleSubmit} className="p-4 border rounded shadow-sm bg-light">
                    ...
                    <button type="submit" className="btn btn-primary glow-on-hover" disabled={loading}>
                ...
                {recipe && (
                    <div className="mt-4 fade-in">
                        <h4 className="text-success">🍲 Generated Recipe:</h4>
                        <pre style={{
                            whiteSpace: "pre-wrap",
